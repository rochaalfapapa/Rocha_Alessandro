...
void recursiveRook (int steps){
    if (steps > 0)
    {
        printf("Direita\n");
        recursiveRook(steps - 1);
    }
...
int main () {
    ...
    */
    ...
    char directionKnight, directionRook;
    ...
    do
    {
        ...
        case 1:
            ...
            scanf("%d", &stepsRook);
            printf("Indique qual será a direção do movimento (c, b, d ou e): ");
            scanf(" %c", &directionRook);
            printf("\nA torre realizará o seguinte movimento:\n");

            recursiveRook(stepsRook);
